...
//		
//		// 숫자만 3자리 문자열
//		if(str.matches("[\\d]{3}"))  // [0-9]{3}   , [\\d]{3} , \\d{3}
//			System.out.println("match");
//		else
...
//			System.out.println("Not match");
		...
		// 이메일    dolsam77@nate.com   => matching
		// 숫자로 시작 x  @없으면 x  , 마지막 문자열 사이즈 크기 제한
//		if(str.matches("^[^0-9]\\w+@{1}[\\w]+[.]{1}[\\w]{3}$"))// ^[\D\\w+@{1}]
//			System.out.println("match");
//		else
//			System.out.println("Not match");
...
//		
	if(str.matches("[^\\s]\\w*\\.(?i)((jpg)|gif|png)$"))
			System.out.println("match");
		else
		System.out.println("Not match");
